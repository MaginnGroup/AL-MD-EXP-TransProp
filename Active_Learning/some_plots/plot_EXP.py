...
data = np.load("../system 1: CO2-nC7/single-fidelity-EXP/data_Diffusivity_EXP.npz")
X_s = data["X_s"]
Y_s = data["Y_s"]
errY_s = data["errY_s"]
...
data = np.load("../system 2: CO2-benzene/single-fidelity-EXP/data_Diffusivity_EXP.npz", allow_pickle=True)
X_s = data["X_s"]
Y_s = data["Y_s"]
errY_s = data["errY_s"]
...
data = np.load("../system 3: toluene-nC6/single-fidelity-EXP/data_Diffusivity_EXP.npz")
X_s = data["X_s"]
Y_s = data["Y_s"]
errY_s = data["errY_s"]
...
data = np.load("../system 1: CO2-nC7/single-fidelity-EXP/data_Diffusivity_EXP_gp.npz")
X_s = data["X_s"]
Y_s = data["Y_s"]
...
data = np.load("../system 2: CO2-benzene/single-fidelity-EXP/data_Diffusivity_EXP_gp.npz", allow_pickle=True)
X_s = data["X_s"]
Y_s = data["Y_s"]
...
data = np.load("../system 3: toluene-nC6/single-fidelity-EXP/data_Diffusivity_EXP_gp.npz")
X_s = data["X_s"]
Y_s = data["Y_s"]
...
data = np.load("../system 1: CO2-nC7/single-fidelity-EXP/data_Viscosity_EXP.npz")
X_s = data["X_s"]
Y_s = data["Y_s"]
errY_s = data["errY_s"]
...
data = np.load("../system 2: CO2-benzene/single-fidelity-EXP/data_Viscosity_EXP.npz", allow_pickle=True)
X_s = data["X_s"]
Y_s = data["Y_s"]
errY_s = data["errY_s"]
...
data = np.load("../system 3: toluene-nC6/single-fidelity-EXP/data_Viscosity_EXP.npz")
X_s = data["X_s"]
Y_s = data["Y_s"]
errY_s = data["errY_s"]
...
data = np.load("../system 1: CO2-nC7/single-fidelity-EXP/data_Viscosity_EXP_gp.npz")
X_s = data["X_s"]
Y_s = data["Y_s"]
...
data = np.load("../system 2: CO2-benzene/single-fidelity-EXP/data_Viscosity_EXP_gp.npz", allow_pickle=True)
X_s = data["X_s"]
Y_s = data["Y_s"]
...
data = np.load("../system 3: toluene-nC6/single-fidelity-EXP/data_Viscosity_EXP_gp.npz")
X_s = data["X_s"]
Y_s = data["Y_s"]
...
axs[0,2].set_yticks([2, 3, 4, 5, 6, 7])
axs[1,2].set_yticks([2, 3, 4, 5, 6])
fig.align_ylabels(axs[:])
#fig.subplots_adjust(wspace=0.35)
#plt.tight_layout()
plt.savefig('plot_systems_EXP.png', dpi=600) 
