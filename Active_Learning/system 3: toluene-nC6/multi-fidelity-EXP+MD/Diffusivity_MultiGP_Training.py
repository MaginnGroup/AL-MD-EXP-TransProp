...
axs[0].plot(X_s[25][:,0], Y_s1[25], color='blue')
axs[0].plot(X_s[50][:,0], Y_s1[50], color='red')
axs[0].plot(X_s[74][:,0], Y_s1[74], color='purple')
axs[0].plot(X_s[98][:,0], Y_s1[98], color='green')
...
axs[0].set_ylabel(r'$D_{fick} \times 10^{-9}$ m²/s')
axs[0].set_xlabel(r'$x_{tol}$')
