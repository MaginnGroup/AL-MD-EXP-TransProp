...
dbPath=r'../Databases'
# Database code
code_high='TOL_NC6_EXP'
code_low='TOL_NC6_MD_30_replicates'
...
X_high=numpy.array([trainDB_high['x1'].values,trainDB_high['T/K'].values]).T
Y_high1=numpy.array([trainDB_high['D/m2s-1'].values]).T *1e9
Y_high2=numpy.array([trainDB_high['Visc/Pas'].values]).T *1e4
errY_high1 = 0.03 * Y_high1
errY_high2 = 0.02 * Y_high2

X_low=numpy.array([trainDB_low['x1'].values,trainDB_low['T/K'].values]).T
...
# Creating a vector for scanning x1,T input conditions
x1_range=numpy.linspace(X_low[:,0].min()*0.999,X_low[:,0].max()*1.001,100)
T_range=numpy.linspace(X_low[:,1].min()*0.999,X_low[:,1].max()*1.001,100)
X_Test=numpy.array([]).reshape(0,2)
for n in range(len(x1_range)):
    T_aux=T_range[n]
    x1_aux=x1_range[n]
    aux1=x1_aux*numpy.ones(len(x1_range)).reshape(-1,1)
...
axs[0,0].text(xhigh[2,0], yhigh2[2]+0.6, f"$\mathbf{str(5)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,0].text(xhigh[3,0], yhigh2[3]-0.7, f"$\mathbf{str(6)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,0].text(xhigh[4,0]+0.05, yhigh2[4]+0.4, f"$\mathbf{str(8)}$", color='black', fontsize=10, ha='center', va='center')

axs[0,1].text(xlow[2,0], ylow2[2]-0.7, f"$\mathbf{str(1)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[3,0]-0.05, ylow2[3]+0.6, f"$\mathbf{str(2)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[4,0]+0.05, ylow2[4]+0.2, f"$\mathbf{str(3)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[5,0], ylow2[5]+0.6, f"$\mathbf{str(4)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[6,0], ylow2[6]-0.7, f"$\mathbf{str(7)}$", color='black', fontsize=10, ha='center', va='center')

axs[1,0].text(xhigh[2,0], yhigh1[2]-0.5, f"$\mathbf{str(5)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,0].text(xhigh[3,0], yhigh1[3]+0.5, f"$\mathbf{str(6)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,0].text(xhigh[4,0]+0.05, yhigh1[4]+0.3, f"$\mathbf{str(8)}$", color='black', fontsize=10, ha='center', va='center')

axs[1,1].text(xlow[2,0], ylow1[2]+0.5, f"$\mathbf{str(1)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[3,0], ylow1[3]-0.6, f"$\mathbf{str(2)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[4,0]+0.05, ylow1[4]+0.2, f"$\mathbf{str(3)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[5,0], ylow1[5]-0.6, f"$\mathbf{str(4)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[6,0], ylow1[6]+0.5, f"$\mathbf{str(7)}$", color='black', fontsize=10, ha='center', va='center')
...
axs[1,0].plot(X_s[25][:,0], Y_s1[25], color='blue')
axs[1,0].plot(X_s[50][:,0], Y_s1[50], color='red')
axs[1,0].plot(X_s[74][:,0], Y_s1[74], color='purple')
axs[1,0].plot(X_s[98][:,0], Y_s1[98], color='green')

axs[0,0].plot(X_s[0][:,0], Y_s2[0], color='black')
axs[0,0].plot(X_s[25][:,0], Y_s2[25], color='blue')
axs[0,0].plot(X_s[50][:,0], Y_s2[50], color='red')
axs[0,0].plot(X_s[74][:,0], Y_s2[74], color='purple')
axs[0,0].plot(X_s[98][:,0], Y_s2[98], color='green')
...
axs[1,1].plot(X_s[25][:,0], Y_s1[25], color='blue')
axs[1,1].plot(X_s[50][:,0], Y_s1[50], color='red')
axs[1,1].plot(X_s[74][:,0], Y_s1[74], color='purple')
axs[1,1].plot(X_s[98][:,0], Y_s1[98], color='green')

axs[0,1].plot(X_s[0][:,0], Y_s2[0], color='black')
axs[0,1].plot(X_s[25][:,0], Y_s2[25], color='blue')
axs[0,1].plot(X_s[50][:,0], Y_s2[50], color='red')
axs[0,1].plot(X_s[74][:,0], Y_s2[74], color='purple')
axs[0,1].plot(X_s[98][:,0], Y_s2[98], color='green')
...
axs[1,0].set_xlabel(r'$x_{tol}$')
axs[1,1].set_xlabel(r'$x_{tol}$')
...
axs[1,0].set_ylim(1.5,6.5)
axs[1,1].set_ylim(1.5,6.5)
