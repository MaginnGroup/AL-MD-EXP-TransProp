...
Y_s = data["Y_s"]
errY_s = data["errY_s"]
axs[0,0].errorbar(X_s[0][:,0], np.squeeze(Y_s[0]), np.squeeze(errY_s[0]), fmt='o', color='black', label='278 K')
axs[0,0].errorbar(X_s[1][:,0], np.squeeze(Y_s[1]), np.squeeze(errY_s[1]), fmt='>', color='blue', label='288 K')
axs[0,0].errorbar(X_s[2][:,0], np.squeeze(Y_s[2]), np.squeeze(errY_s[2]), fmt='*', color='red', label='298 K')
axs[0,0].errorbar(X_s[3][:,0], np.squeeze(Y_s[3]), np.squeeze(errY_s[3]), fmt='D', color='purple', label='308 K')
axs[0,0].errorbar(X_s[4][:,0], np.squeeze(Y_s[4]), np.squeeze(errY_s[4]), fmt='^', color='green', label='318 K')
...
Y_s = data["Y_s"]
errY_s = data["errY_s"]
axs[1,0].errorbar(X_s[0][:,0], np.squeeze(Y_s[0]), np.squeeze(errY_s[0]), fmt='o', color='black', label='278 K')
axs[1,0].errorbar(X_s[1][:,0], np.squeeze(Y_s[1]), np.squeeze(errY_s[1]), fmt='>', color='blue', label='288 K')
axs[1,0].errorbar(X_s[2][:,0], np.squeeze(Y_s[2]), np.squeeze(errY_s[2]), fmt='*', color='red', label='298 K')
axs[1,0].errorbar(X_s[3][:,0], np.squeeze(Y_s[3]), np.squeeze(errY_s[3]), fmt='D', color='purple', label='308 K')
axs[1,0].errorbar(X_s[4][:,0], np.squeeze(Y_s[4]), np.squeeze(errY_s[4]), fmt='^', color='green', label='318 K')
...
Y_s = data["Y_s"]
errY_s = data["errY_s"]
axs[0,1].errorbar(X_s[0][:,0], np.squeeze(Y_s[0]), np.squeeze(errY_s[0]), fmt='o', color='black', label='278 K')
axs[0,1].errorbar(X_s[1][:,0], np.squeeze(Y_s[1]), np.squeeze(errY_s[1]), fmt='>', color='blue', label='288 K')
axs[0,1].errorbar(X_s[2][:,0], np.squeeze(Y_s[2]), np.squeeze(errY_s[2]), fmt='*', color='red', label='298 K')
axs[0,1].errorbar(X_s[3][:,0], np.squeeze(Y_s[3]), np.squeeze(errY_s[3]), fmt='D', color='purple', label='308 K')
axs[0,1].errorbar(X_s[4][:,0], np.squeeze(Y_s[4]), np.squeeze(errY_s[4]), fmt='^', color='green', label='318 K')
...
Y_s = data["Y_s"]
errY_s = data["errY_s"]
axs[1,1].errorbar(X_s[0][:,0], np.squeeze(Y_s[0]), np.squeeze(errY_s[0]), fmt='o', color='black', label='278 K')
axs[1,1].errorbar(X_s[1][:,0], np.squeeze(Y_s[1]), np.squeeze(errY_s[1]), fmt='>', color='blue', label='288 K')
axs[1,1].errorbar(X_s[2][:,0], np.squeeze(Y_s[2]), np.squeeze(errY_s[2]), fmt='*', color='red', label='298 K')
axs[1,1].errorbar(X_s[3][:,0], np.squeeze(Y_s[3]), np.squeeze(errY_s[3]), fmt='D', color='purple', label='308 K')
axs[1,1].errorbar(X_s[4][:,0], np.squeeze(Y_s[4]), np.squeeze(errY_s[4]), fmt='^', color='green', label='318 K')
