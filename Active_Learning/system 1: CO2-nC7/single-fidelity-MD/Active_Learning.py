...
dy1 = [2.0, -2.0, 1.2, 2.0, -2.2]
dx1 = [0, 0, -40, 0, 0]
dy2 = [-0.9, 0.75, 0.3, -1, 0.75]
dx2 = [0, 0, -40, 0, 0]
...
axs[1].errorbar(X_s[0][:,0], numpy.squeeze(Y_s1[0]), numpy.squeeze(errY_s1[0]), fmt='o', color='black', label='298 K')
axs[1].errorbar(X_s[1][:,0], numpy.squeeze(Y_s1[1]), numpy.squeeze(errY_s1[1]), fmt='>', color='blue', label='323 K')
axs[1].errorbar(X_s[2][:,0], numpy.squeeze(Y_s1[2]), numpy.squeeze(errY_s1[2]), fmt='*', color='red', label='348 K')
axs[1].errorbar(X_s[3][:,0], numpy.squeeze(Y_s1[3]), numpy.squeeze(errY_s1[3]), fmt='D', color='purple', label='373 K')
axs[1].errorbar(X_s[4][:,0], numpy.squeeze(Y_s1[4]), numpy.squeeze(errY_s1[4]), fmt='^', color='green', label='398 K')
axs[1].errorbar(X_s[5][:,0], numpy.squeeze(Y_s1[5]), numpy.squeeze(errY_s1[5]), fmt='o', color='m', label='423 K')
...
axs[0].errorbar(X_s[5][:,0], numpy.squeeze(Y_s2[5]), numpy.squeeze(errY_s2[5]), fmt='o', color='m')
...
axs[0].plot(X_s[20][:,0], Y_s2[20], color='blue')
axs[0].plot(X_s[40][:,0], Y_s2[40], color='red')
axs[0].plot(X_s[59][:,0], Y_s2[59], color='purple')
axs[0].plot(X_s[79][:,0], Y_s2[79], color='green')
axs[0].plot(X_s[99][:,0], Y_s2[99], color='m')
