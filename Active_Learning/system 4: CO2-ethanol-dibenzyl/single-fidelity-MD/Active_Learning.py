...
axs[0,2].text(X_s[2][2,0], Y_s2[2][2]+1, f"$\mathbf{str(4)}$", color='black', fontsize=10, ha='center', va='center')    
axs[0,1].text(X_s[1][0,0], Y_s2[1][0]+1, f"$\mathbf{str(5)}$", color='black', fontsize=10, ha='center', va='center')    
axs[0,0].text(X_s[0][3,0], Y_s2[0][3]+1, f"$\mathbf{str(6)}$", color='black', fontsize=10, ha='center', va='center')   
axs[0,2].text(X_s[2][3,0], Y_s2[2][3]+1, f"$\mathbf{str(7)}$", color='black', fontsize=10, ha='center', va='center')    
...
axs[0,1].text(X_s[1][2,0], Y_s2[1][2]+1, f"$\mathbf{str(11)}$", color='black', fontsize=10, ha='center', va='center')   
axs[0,2].text(X_s[2][5,0], Y_s2[2][5]+1, f"$\mathbf{str(12)}$", color='black', fontsize=10, ha='center', va='center')   
axs[0,1].text(X_s[1][3,0], Y_s2[1][3]+1, f"$\mathbf{str(13)}$", color='black', fontsize=10, ha='center', va='center')   
...
axs[1,1].text(X_s[1][0,0], Y_s1[1][0]+1, f"$\mathbf{str(5)}$", color='black', fontsize=10, ha='center', va='center')    
axs[1,0].text(X_s[0][3,0], Y_s1[0][3]+1, f"$\mathbf{str(6)}$", color='black', fontsize=10, ha='center', va='center')   
axs[1,2].text(X_s[2][3,0], Y_s1[2][3]+1, f"$\mathbf{str(7)}$", color='black', fontsize=10, ha='center', va='center')    
axs[1,2].text(X_s[2][4,0]+20, Y_s1[2][4]+0.2, f"$\mathbf{str(8)}$", color='black', fontsize=10, ha='center', va='center')   
...
axs[1,1].text(X_s[1][2,0], Y_s1[1][2]+1, f"$\mathbf{str(11)}$", color='black', fontsize=10, ha='center', va='center')   
axs[1,2].text(X_s[2][5,0], Y_s1[2][5]+1, f"$\mathbf{str(12)}$", color='black', fontsize=10, ha='center', va='center')   
...
fig.suptitle(r'\textbf{MD Data}', x=0.53, fontsize=10)
