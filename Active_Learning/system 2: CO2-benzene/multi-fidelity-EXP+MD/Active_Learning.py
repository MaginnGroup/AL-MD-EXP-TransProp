...
dbPath=r'../Databases'
# Database code
code_high='BENZ_SCO2_EXP'
code_low='BENZ_SCO2_MD_30_replicates'
...
Y_high2=numpy.array([trainDB_high['Visc/Pas'].values]).T *1e5
...
Y_low2=numpy.array([trainDB_low['Visc/Pas'].values]).T *1e5
errY_low1=numpy.array([trainDB_low['errD'].values]).T *1e9
errY_low2=numpy.array([trainDB_low['errVisc'].values]).T *1e5
...
axs[1,0].plot(xhigh[:,1], yhigh1, 'o', color='black', markersize=10, markerfacecolor='none')
axs[1,1].plot(xlow[:,1], ylow1, 'o', color='black', markersize=10, markerfacecolor='none')
axs[0,0].plot(xhigh[:,1], yhigh2, 'o', color='black', markersize=10, markerfacecolor='none')
axs[0,1].plot(xlow[:,1], ylow2, 'o', color='black', markersize=10, markerfacecolor='none')


axs[0,1].text(xlow[2,1], ylow2[2]-1.2, f"$\mathbf{str(1)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[3,1], ylow2[3]+1, f"$\mathbf{str(2)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[4,1]+5, ylow2[4]+0.5, f"$\mathbf{str(3)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[5,1], ylow2[5]+1, f"$\mathbf{str(4)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[6,1], ylow2[6]-1.2, f"$\mathbf{str(7)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[7,1]+5, ylow2[7]+0.5, f"$\mathbf{str(8)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[8,1]-5, ylow2[8]+0.5, f"$\mathbf{str(10)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,1].text(xlow[9,1], ylow2[9]+1, f"$\mathbf{str(14)}$", color='black', fontsize=10, ha='center', va='center')

axs[0,0].text(xhigh[2,1]-5, yhigh2[2]+0.5, f"$\mathbf{str(5)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,0].text(xhigh[3,1], yhigh2[3]-1.2, f"$\mathbf{str(6)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,0].text(xhigh[4,1]+5, yhigh2[4]+0.5, f"$\mathbf{str(9)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,0].text(xhigh[5,1]+5, yhigh2[5]+0.5, f"$\mathbf{str(11)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,0].text(xhigh[6,1]-5, yhigh2[6]+0.5, f"$\mathbf{str(12)}$", color='black', fontsize=10, ha='center', va='center')
axs[0,0].text(xhigh[7,1], yhigh2[7]-1.2, f"$\mathbf{str(13)}$", color='black', fontsize=10, ha='center', va='center')

axs[1,1].text(xlow[2,1], ylow1[2]+8, f"$\mathbf{str(1)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[3,1], ylow1[3]-10, f"$\mathbf{str(2)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[4,1]+5, ylow1[4]+4, f"$\mathbf{str(3)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[5,1], ylow1[5]-10, f"$\mathbf{str(4)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[6,1], ylow1[6]+8, f"$\mathbf{str(7)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[7,1], ylow1[7]+11, f"$\mathbf{str(8)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[8,1], ylow1[8]+8, f"$\mathbf{str(10)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,1].text(xlow[9,1], ylow1[9]-10, f"$\mathbf{str(14)}$", color='black', fontsize=10, ha='center', va='center')

axs[1,0].text(xhigh[2,1], yhigh1[2]-10, f"$\mathbf{str(5)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,0].text(xhigh[3,1], yhigh1[3]+8, f"$\mathbf{str(6)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,0].text(xhigh[4,1], yhigh1[4]-10, f"$\mathbf{str(9)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,0].text(xhigh[5,1], yhigh1[5]+8, f"$\mathbf{str(11)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,0].text(xhigh[6,1], yhigh1[6]+8, f"$\mathbf{str(12)}$", color='black', fontsize=10, ha='center', va='center')
axs[1,0].text(xhigh[7,1], yhigh1[7]+8, f"$\mathbf{str(13)}$", color='black', fontsize=10, ha='center', va='center')


temps = numpy.unique(X_high[:, 0])
X_s = []
Y_s1 = []
Y_s2 = []
errY_s1 = []
errY_s2 = []
for temp in temps:
    indices = numpy.where(X_high[:, 0] == temp)[0]
...
axs[1,0].errorbar(X_s[0][:,1], numpy.squeeze(Y_s1[0]), numpy.squeeze(errY_s1[0]), fmt='o', color='black')
axs[1,0].errorbar(X_s[1][:,1], numpy.squeeze(Y_s1[1]), numpy.squeeze(errY_s1[1]), fmt='>', color='blue')
axs[1,0].errorbar(X_s[2][:,1], numpy.squeeze(Y_s1[2]), numpy.squeeze(errY_s1[2]), fmt='*', color='red')
axs[1,0].errorbar(X_s[3][:,1], numpy.squeeze(Y_s1[3]), numpy.squeeze(errY_s1[3]), fmt='D', color='purple')
axs[1,0].errorbar(X_s[4][:,1], numpy.squeeze(Y_s1[4]), numpy.squeeze(errY_s1[4]), fmt='^', color='green')
axs[1,0].errorbar(X_s[5][:,1], numpy.squeeze(Y_s1[5]), numpy.squeeze(errY_s1[5]), fmt='o', color='m')

axs[0,0].errorbar(X_s[0][:,1], numpy.squeeze(Y_s2[0]), numpy.squeeze(errY_s2[0]), fmt='o', color='black')
axs[0,0].errorbar(X_s[1][:,1], numpy.squeeze(Y_s2[1]), numpy.squeeze(errY_s2[1]), fmt='>', color='blue')
axs[0,0].errorbar(X_s[2][:,1], numpy.squeeze(Y_s2[2]), numpy.squeeze(errY_s2[2]), fmt='*', color='red')
axs[0,0].errorbar(X_s[3][:,1], numpy.squeeze(Y_s2[3]), numpy.squeeze(errY_s2[3]), fmt='D', color='purple')
axs[0,0].errorbar(X_s[4][:,1], numpy.squeeze(Y_s2[4]), numpy.squeeze(errY_s2[4]), fmt='^', color='green')
axs[0,0].errorbar(X_s[5][:,1], numpy.squeeze(Y_s2[5]), numpy.squeeze(errY_s2[5]), fmt='o', color='m')

temps = numpy.unique(X_low[:, 0])
X_s = []
Y_s1 = []
Y_s2 = []
errY_s1 = []
errY_s2 = []
for temp in temps:
    indices = numpy.where(X_low[:, 0] == temp)[0]
...
axs[1,1].errorbar(X_s[0][:,1], numpy.squeeze(Y_s1[0]), numpy.squeeze(errY_s1[0]), fmt='o', color='black')
axs[1,1].errorbar(X_s[1][:,1], numpy.squeeze(Y_s1[1]), numpy.squeeze(errY_s1[1]), fmt='>', color='blue')
axs[1,1].errorbar(X_s[2][:,1], numpy.squeeze(Y_s1[2]), numpy.squeeze(errY_s1[2]), fmt='*', color='red')
axs[1,1].errorbar(X_s[3][:,1], numpy.squeeze(Y_s1[3]), numpy.squeeze(errY_s1[3]), fmt='D', color='purple')
axs[1,1].errorbar(X_s[4][:,1], numpy.squeeze(Y_s1[4]), numpy.squeeze(errY_s1[4]), fmt='^', color='green')
axs[1,1].errorbar(X_s[5][:,1], numpy.squeeze(Y_s1[5]), numpy.squeeze(errY_s1[5]), fmt='o', color='m')

axs[0,1].errorbar(X_s[0][:,1], numpy.squeeze(Y_s2[0]), numpy.squeeze(errY_s2[0]), fmt='o', color='black')
axs[0,1].errorbar(X_s[1][:,1], numpy.squeeze(Y_s2[1]), numpy.squeeze(errY_s2[1]), fmt='>', color='blue')
axs[0,1].errorbar(X_s[2][:,1], numpy.squeeze(Y_s2[2]), numpy.squeeze(errY_s2[2]), fmt='*', color='red')
axs[0,1].errorbar(X_s[3][:,1], numpy.squeeze(Y_s2[3]), numpy.squeeze(errY_s2[3]), fmt='D', color='purple')
axs[0,1].errorbar(X_s[4][:,1], numpy.squeeze(Y_s2[4]), numpy.squeeze(errY_s2[4]), fmt='^', color='green')
axs[0,1].errorbar(X_s[5][:,1], numpy.squeeze(Y_s2[5]), numpy.squeeze(errY_s2[5]), fmt='o', color='m')
...
axs[1,0].plot(X_s[0][:,1], Y_s1[0], color='black')
axs[1,0].plot(X_s[5][:,1], Y_s1[5], color='blue')
axs[1,0].plot(X_s[15][:,1], Y_s1[15], color='red')
axs[1,0].plot(X_s[25][:,1], Y_s1[25], color='purple')
axs[1,0].plot(X_s[49][:,1], Y_s1[49], color='green')
axs[1,0].plot(X_s[99][:,1], Y_s1[99], color='m')

axs[0,0].plot(X_s[0][:,1], Y_s2[0], color='black')
axs[0,0].plot(X_s[5][:,1], Y_s2[5], color='blue')
axs[0,0].plot(X_s[15][:,1], Y_s2[15], color='red')
axs[0,0].plot(X_s[25][:,1], Y_s2[25], color='purple')
axs[0,0].plot(X_s[49][:,1], Y_s2[49], color='green')
axs[0,0].plot(X_s[99][:,1], Y_s2[99], color='m')
...
axs[1,1].plot(X_s[0][:,1], Y_s1[0], color='black')
axs[1,1].plot(X_s[5][:,1], Y_s1[5], color='blue')
axs[1,1].plot(X_s[15][:,1], Y_s1[15], color='red')
axs[1,1].plot(X_s[25][:,1], Y_s1[25], color='purple')
axs[1,1].plot(X_s[49][:,1], Y_s1[49], color='green')
axs[1,1].plot(X_s[99][:,1], Y_s1[99], color='m')

axs[0,1].plot(X_s[0][:,1], Y_s2[0], color='black')
axs[0,1].plot(X_s[5][:,1], Y_s2[5], color='blue')
axs[0,1].plot(X_s[15][:,1], Y_s2[15], color='red')
axs[0,1].plot(X_s[25][:,1], Y_s2[25], color='purple')
axs[0,1].plot(X_s[49][:,1], Y_s2[49], color='green')
axs[0,1].plot(X_s[99][:,1], Y_s2[99], color='m')
...
axs[0,0].set_xticks([300,320,340,360,380])
axs[0,1].set_xticks([300,320,340,360,380])
axs[1,0].set_xticks([300,320,340,360,380])
axs[1,1].set_xticks([300,320,340,360,380])
axs[1,0].set_ylim(-5,90)
axs[1,1].set_ylim(-5,90)
