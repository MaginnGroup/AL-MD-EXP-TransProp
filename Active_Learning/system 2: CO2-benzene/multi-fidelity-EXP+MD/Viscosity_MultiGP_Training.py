...
Y_high1=numpy.array([trainDB_high['Visc/Pas'].values]).T *1e5
errY_high1=0.02*Y_high1

X_low=numpy.array([trainDB_low['P/bar'].values,trainDB_low['T/K'].values]).T
Y_low1=numpy.array([trainDB_low['Visc/Pas'].values]).T *1e5
errY_low1=numpy.array([trainDB_low['errVisc'].values]).T *1e5
...
axs[0].errorbar(X_s[0][:,1], numpy.squeeze(Y_s1[0]), numpy.squeeze(errY_s1[0]), fmt='o', color='black')
axs[0].errorbar(X_s[1][:,1], numpy.squeeze(Y_s1[1]), numpy.squeeze(errY_s1[1]), fmt='>', color='blue')
axs[0].errorbar(X_s[2][:,1], numpy.squeeze(Y_s1[2]), numpy.squeeze(errY_s1[2]), fmt='*', color='red')
axs[0].errorbar(X_s[3][:,1], numpy.squeeze(Y_s1[3]), numpy.squeeze(errY_s1[3]), fmt='D', color='purple')
axs[0].errorbar(X_s[4][:,1], numpy.squeeze(Y_s1[4]), numpy.squeeze(errY_s1[4]), fmt='^', color='green')
axs[0].errorbar(X_s[5][:,1], numpy.squeeze(Y_s1[5]), numpy.squeeze(errY_s1[5]), fmt='o', color='m')
...
axs[1].errorbar(X_s[0][:,1], numpy.squeeze(Y_s1[0]), numpy.squeeze(errY_s1[0]), fmt='o', color='black')
axs[1].errorbar(X_s[1][:,1], numpy.squeeze(Y_s1[1]), numpy.squeeze(errY_s1[1]), fmt='>', color='blue')
axs[1].errorbar(X_s[2][:,1], numpy.squeeze(Y_s1[2]), numpy.squeeze(errY_s1[2]), fmt='*', color='red')
axs[1].errorbar(X_s[3][:,1], numpy.squeeze(Y_s1[3]), numpy.squeeze(errY_s1[3]), fmt='D', color='purple')
axs[1].errorbar(X_s[4][:,1], numpy.squeeze(Y_s1[4]), numpy.squeeze(errY_s1[4]), fmt='^', color='green')
axs[1].errorbar(X_s[5][:,1], numpy.squeeze(Y_s1[5]), numpy.squeeze(errY_s1[5]), fmt='o', color='m')
...
axs[0].plot(X_s[0][:,1], Y_s1[0], color='black')
axs[0].plot(X_s[5][:,1], Y_s1[5], color='blue')
axs[0].plot(X_s[15][:,1], Y_s1[15], color='red')
axs[0].plot(X_s[25][:,1], Y_s1[25], color='purple')
axs[0].plot(X_s[49][:,1], Y_s1[49], color='green')
axs[0].plot(X_s[99][:,1], Y_s1[99], color='m')
