...
numpy.savez("data_Diffusivity_MD.npz", X_s=X_s, Y_s=Y_s, errY_s=errY_s)
...
numpy.savez("data_Diffusivity_MD_gp.npz", X_s=X_s, Y_s=Y_s, STD_s=STD_s)

plt.ylabel(r'$D \times 10^{-9}$ m²/s')
plt.xlabel(r'$T$ (K)')
