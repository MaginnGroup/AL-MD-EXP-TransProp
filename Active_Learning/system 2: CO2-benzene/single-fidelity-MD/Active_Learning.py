...
errY_Exp2=numpy.array([trainDB['errVisc'].values]).T *1e5
...
dy1 = [8, -10, -10, 10, 7, 8, -10, 3, -10, -10, 6, 8, -10, 2, -10]
dx1 = [0, 0, 0, 0, 2, 0, 0, 5, 0, 0, 5, 0, 0, -6, 0]
dy2 = [-1.3, 1, -0.6, 0, 0.6, -1.3, 1, 0, 0, 1, 0.6, -1.3, 1, 0.6, 1]
dx2 = [0, 0, -4, 5, -3, 0, 0, -5, 5, 0, -5, 0, 0, -5, 0]
