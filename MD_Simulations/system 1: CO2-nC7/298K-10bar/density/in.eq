...
velocity        all create 298.0 123456

minimize        1.0e-4 1.0e-6 1000 1000

fix             nvt1 all nvt temp 298.0 700.0 100.0
run             25000
unfix           nvt1
fix             nvt2 all nvt temp 700.0 700.0 100.0
run             2000000 
unfix           nvt2
fix             nvt3 all nvt temp 700.0 298.0 100.0
run             300000 
unfix           nvt3
fix             nvt4 all nvt temp 298.0 298.0 100.0
run             2000000 
unfix           nvt4

fix             npt1 all npt temp 298.0 298.0 100.0 iso 9.86923 9.86923 1000.0
...
fix             nvta all nvt temp 298.0 298.0 100.0
